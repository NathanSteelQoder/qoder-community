...
For the authoritative skill schema reference with all required and optional fields, examples, and validation rules, see **[SKILL_SCHEMA.md](SKILL_SCHEMA.md)**.
...
- **Share images**: Images are automatically generated by the platform. No manual image upload needed.
- See [DEPLOYMENT.md](DEPLOYMENT.md) for the `npm run capture` screenshot pipeline.
